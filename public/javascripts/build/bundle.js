...
/***/ function(module, exports, __webpack_require__) {
	...
	var _scrolldot = __webpack_require__(160);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	(0, _reactDom.render)(_react2.default.createElement(_scrolldot.ScrollBlock, null), document.getElementById('scrollhook'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ScrollBlock = _react2.default.createClass({
	    displayName: 'ScrollBlock',
	    _getSectionCount: function _getSectionCount() {
	        return document.querySelectorAll('section.page').length;
	    },
	    render: function render() {
	        var sectionCount = this._getSectionCount();
	        var dots = [];
	        for (var i = 0; i < sectionCount; i++) {
	            dots.push(_react2.default.createElement(ScrollDot, { page: i, key: i }));
	        }
	        return _react2.default.createElement(
	            'div',
	            { className: 'scroll-block', style: styles.block },
	            dots
	        );
	    }
	});

	var ScrollDot = _react2.default.createClass({
	    displayName: 'ScrollDot',
	    ...
	    render: function render() {
	        var dotStyle = this.state.focus ? Object.assign({}, styles.dot, styles.focus) : Object.assign({}, styles.dot, {});
	        var inkStyle = this.state.focus ? Object.assign({}, styles.ink, styles.ripple) : Object.assign({}, styles.ink, {});
	        return _react2.default.createElement(
	            'div',
	            { className: 'dot shadow', style: dotStyle },
	            _react2.default.createElement('span', { className: 'ink', style: inkStyle })
	        );
	    }
	});

	module.exports = { ScrollBlock: ScrollBlock, ScrollDot: ScrollDot };
